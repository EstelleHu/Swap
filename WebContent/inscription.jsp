...
<body>
	...
	<div class="col-md-4 offset-md-4">
		...
		<form action="InscriptionServlet" method="POST">
			<div class="mb-3">
				<label for="inputNom" class="col-form-label">Nom</label> <input
					type="text" class="form-control" id="inputNom" name="inputNom"
					required>
			</div>
			<div class="mb-3">
				<label for="inputPrenom" class="col-form-label">Prénom</label> <input
